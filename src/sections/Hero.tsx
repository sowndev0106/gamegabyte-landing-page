...
export function Hero() {
  return (
    <section id="home" className="relative flex min-h-screen items-center overflow-hidden bg-black pt-24">
      <img src={assets.hero} alt="" className="absolute inset-0 h-full w-full object-cover opacity-20" />
      ...
      <Container className="relative z-10">
        <Stagger className="mx-auto flex max-w-4xl flex-col items-center gap-7 text-center">
          <StaggerItem>
